			...
			<table width="400" border="1">
				...
				<tr height="40">
					...
					<td width="250"><input type="password" name="pass1"
						value="<%=mbean.getPass1()%>" placeholder="비밀번호 확인" /></td>
				</tr>
				...
				<tr height="40">
					...
					<td width="250"><input type="phone" name="phone"
				...
				<tr height="40">
					...
					<input type="submit" value="수정완료" />
						<p></p>
						<input type="button" value="전체회원보기" onclick="location.href='MemberList.jsp'" /></td>
				</tr>
			</table>
		</form>
	</center>
